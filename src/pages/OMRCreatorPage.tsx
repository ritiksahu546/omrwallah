...
export const OMRCreatorPage: React.FC<OMRCreatorPageProps> = ({
  ...
  return (
    <div className="flex flex-col h-full bg-slate-100 overflow-hidden">
      ...
      <div className="bg-white border-b border-slate-200 px-4 py-2.5 flex flex-wrap items-center justify-between gap-3 shadow-2xs z-20">
        <div>
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="lg:hidden px-3 py-2 text-xs font-bold bg-slate-100 hover:bg-slate-200 text-slate-700 rounded-xl flex items-center gap-1.5 cursor-pointer"
          >
            <Eye className="w-4 h-4 text-blue-600" />
            <span>{mobilePreviewOpen ? 'Edit Settings' : 'Live Preview'}</span>
          </button>
          ...
          <button
            type="button"
            onClick={handleSave}
            className="px-3.5 py-2 text-xs font-bold bg-white hover:bg-slate-50 text-slate-700 border border-slate-300 rounded-xl shadow-xs transition-colors flex items-center gap-1.5 cursor-pointer"
          >
          ...
          <button
            ...
            className="px-4 py-2 text-xs font-extrabold bg-blue-600 hover:bg-blue-700 text-white rounded-xl shadow-sm shadow-blue-500/25 transition-all flex items-center gap-1.5 cursor-pointer disabled:opacity-50"
          >
          ...
          <button
            type="button"
            onClick={handlePrint}
            className="px-3.5 py-2 text-xs font-bold bg-slate-900 hover:bg-slate-800 text-white rounded-xl shadow-xs transition-colors flex items-center gap-1.5 cursor-pointer"
          >
      ...
      <div className="flex-1 flex overflow-hidden relative">
        ...
        >
          ...
          <div className="flex items-center overflow-x-auto border-b border-slate-200 bg-slate-50/70 p-1.5 gap-1 scrollbar-none">
            {tabs.map((tab) => (
              <button
                key={tab.id}
                type="button"
        ...
        >
          ...
          <div className="lg:hidden p-3 bg-white border-t border-slate-200 flex gap-2">
            <button
              type="button"
